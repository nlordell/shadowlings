...
const REGISTER_TOPIC = "0xf59eb4b970a508b6ce525562982957de66286828bcbbcf770f802c8fad2d575b"

export const queryRecoveryRegistrations = async(shadow: string): Promise<string | undefined> => {
